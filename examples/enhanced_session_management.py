...
This example demonstrates how to use the enhanced session management features
of LG-ADK to build a multi-user conversational application with rich analytics
and user tracking.
"""
...
def main():
    ...
    session_manager.update_session_metadata(
        alice_session,
        {"subscription": "premium", "last_topic": "neural networks"},
        merge=True
    )
