# 🏗️ Graph Builder Example with LG-ADK

This example demonstrates how to create a graph using the `GraphBuilder`, with two agents that process the input sequentially.
