"""
Agent Tools for LG-ADK

This module provides a collection of tools for agents to use:
1. DelegationTool: For delegating tasks to other agents
2. MemoryTool: For storing and retrieving memories
3. UserInfoTool: For managing user information
"""
...
class DelegationTool:
    ...
    def delegate(self, agent_name: str, input_data: Dict[str, Any], 
                 wait: bool = True, timeout: Optional[float] = None) -> Dict[str, Any]:
    ...
    async def adelegate(self, agent_name: str, input_data: Dict[str, Any],
                       wait: bool = True, timeout: Optional[float] = None) -> Dict[str, Any]:
...
class MemoryTool:
    ...
    def __init__(self, config: Optional[MemoryToolConfig] = None):
    ...
    def store(self, session_id: str, content: Any, 
    ...
    def retrieve(self, session_id: str, query: Dict[str, Any] = None, 
                limit: int = 10, sort_by: str = "timestamp",
    ...
    def retrieve_by_tags(self, session_id: str, tags: List[str],
                       match_all: bool = False, limit: int = 10) -> List[Dict[str, Any]]:
...
class UserInfoTool:
    ...
    def get_preference(self, user_id: str, key: str, 
                     category: str = "general", default: Any = None) -> Any:
    ...
    def get_preferences(self, user_id: str, category: str = None) -> Dict[str, Any]:
...
def register_agent_tools(agent: Agent, tools: Dict[str, Union[DelegationTool, MemoryTool, UserInfoTool]]) -> None:
