...
class DatabaseManager(BaseModel):
    ...
    def save_session(
        self, session_id: str, user_id: Optional[str], metadata: Dict[str, Any]
    ) -> None:
        """
        ...
        if results:
            ...
            # Insert new session
            self.execute_update(
                "INSERT INTO sessions (id, user_id, created_at, last_active, metadata) VALUES (?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, ?)",
